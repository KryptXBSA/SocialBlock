   ...
   <div className="w-full">
    <div className="flex w-full flex-row">
     <textarea
      ...
      placeholder={`Hey ${username ? username : ""} How’s it going?`}
     />
    ...
    <div className="   form-control">
     <form onSubmit={newPost}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M7 20l4-16m2 16l4-16M6 9h14M4 15h14" />
       ...
       <button
        onClick={newPost}
        className="p-3 px-4 transition duration-300  font-semibold btn1 tracking-normal text-lg  dark:bg-slate-800 ml-auto rounded-2xl ">
